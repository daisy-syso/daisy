...
'use strict';
var angularLocalStorage = angular.module('angular-local-storage', []);

angularLocalStorage.provider('$localStorage', function() {

  // You should set a prefix to avoid overwriting any local storage variables from the rest of your app
  // e.g. $localStorageProvider.setPrefix('youAppName');
  // With provider you can use config as this:
  // myApp.config(function ($localStorageProvider) {
  //    $localStorageProvider.prefix = 'yourAppName';
  // });
  this.prefix = 'ls';
  ...
  this.$get = ['$rootScope', '$window', '$document', function($rootScope, $window, $document) {
    ...
    // Example use: var keys = $localStorage.keys()
    ...
    // Example use: $localStorage.cookie.add('library','angular');
    ...
    // Example use: $localStorage.cookie.get('library'); // returns 'angular'
