...
class EditorsControllerTest < ActionController::TestCase
  ...
  test "should create editor" do
    assert_difference('Editor.count') do
      post :create, editor: { email: @editor.email, password_hash: @editor.password_hash, telephone: @editor.telephone, username: @editor.username }
    end
  ...
  test "should update editor" do
    patch :update, id: @editor, editor: { email: @editor.email, password_hash: @editor.password_hash, telephone: @editor.telephone, username: @editor.username }
    assert_redirected_to editor_path(assigns(:editor))
  end
